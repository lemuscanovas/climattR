...
Z500 <- rast("inst/testdata/eobs_weu/z500_0509_1950_2023_eu.nc")
tx <- rast("inst/testdata/eobs_weu/tx_0608_1950_2023_weu.nc") /10
...
a_tx+b_tx + plot_layout(widths = c(2, 1))
```
...
(a_z500+b_z500 + plot_layout(widths = c(2, 1)))
```
